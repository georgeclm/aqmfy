                        ...
                        <div class="modal-body">
                            <form action="{{ route('ratings.store') }}" id="ratingform" method="POST">
                                ...
                                <div class="form-group">
                                    <textarea name="comment" placeholder="Describe your satisfaction" class="form-control"
                                        rows="5" required></textarea>
                                </div>
                                <input type="hidden" name="service_id" value="{{ $ratingserviceid }}">
                            </form>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <input type="submit" form="ratingform" class="btn btn-primary" value="Submit Rating" />
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row searched-item cart-list-divider">
                            ...
                            <div class="col-sm-2">
                                <form action="{{ route('orders.destroy', $order->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button class="btn btn-outline-success">Finish Order</button>
                                </form>
